-- https://github.com/subsoap/defsteam/blob/master/defsteam/steamworks.lua
...
typedef void( * SteamWorks_PFNLegacyKeyRegistration)(const char * ,
  const char * );
...
typedef void( * SteamWorks_SteamAPIWarningMessageHook_t)(int,
  const char * );
...
typedef struct SteamWorks_ISteamClient {}
SteamWorks_ISteamClient;
typedef struct SteamWorks_ISteamUser {}
SteamWorks_ISteamUser;
typedef struct SteamWorks_ISteamFriends {}
SteamWorks_ISteamFriends;
typedef struct SteamWorks_ISteamUtils {}
SteamWorks_ISteamUtils;
typedef struct SteamWorks_ISteamMatchmaking {}
SteamWorks_ISteamMatchmaking;
typedef struct SteamWorks_ISteamUserStats {}
SteamWorks_ISteamUserStats;
typedef struct SteamWorks_ISteamApps {}
SteamWorks_ISteamApps;
typedef struct SteamWorks_ISteamMatchmakingServers {}
SteamWorks_ISteamMatchmakingServers;
typedef struct SteamWorks_ISteamNetworking {}
SteamWorks_ISteamNetworking;
typedef struct SteamWorks_ISteamRemoteStorage {}
SteamWorks_ISteamRemoteStorage;
typedef struct SteamWorks_ISteamScreenshots {}
SteamWorks_ISteamScreenshots;
typedef struct SteamWorks_ISteamHTTP {}
SteamWorks_ISteamHTTP;
typedef struct SteamWorks_ISteamUnifiedMessages {}
SteamWorks_ISteamUnifiedMessages;
typedef struct SteamWorks_ISteamController {}
SteamWorks_ISteamController;
typedef struct SteamWorks_ISteamUGC {}
SteamWorks_ISteamUGC;
typedef struct SteamWorks_ISteamAppList {}
SteamWorks_ISteamAppList;
typedef struct SteamWorks_ISteamMusic {}
SteamWorks_ISteamMusic;
typedef struct SteamWorks_ISteamMusicRemote {}
SteamWorks_ISteamMusicRemote;
typedef struct SteamWorks_ISteamHTMLSurface {}
SteamWorks_ISteamHTMLSurface;
typedef struct SteamWorks_ISteamInventory {}
SteamWorks_ISteamInventory;
typedef struct SteamWorks_ISteamVideo {}
SteamWorks_ISteamVideo;
typedef struct SteamWorks_ISteamGameServer {}
SteamWorks_ISteamGameServer;
typedef struct SteamWorks_ISteamGameServerStats {}
SteamWorks_ISteamGameServerStats;
typedef struct SteamWorks_ISteamMatchmakingServerListResponse {}
SteamWorks_ISteamMatchmakingServerListResponse;
typedef struct SteamWorks_ISteamMatchmakingPlayersResponse {}
SteamWorks_ISteamMatchmakingPlayersResponse;
typedef struct SteamWorks_ISteamMatchmakingPingResponse {}
SteamWorks_ISteamMatchmakingPingResponse;
typedef struct SteamWorks_ISteamMatchmakingRulesResponse {}
SteamWorks_ISteamMatchmakingRulesResponse;
...
SteamWorks_ISteamUser * SteamAPI_ISteamClient_GetISteamUser(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamGameServer * SteamAPI_ISteamClient_GetISteamGameServer(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
...
SteamWorks_ISteamFriends * SteamAPI_ISteamClient_GetISteamFriends(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamUtils * SteamAPI_ISteamClient_GetISteamUtils(SteamWorks_ISteamClient * self, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamMatchmaking * SteamAPI_ISteamClient_GetISteamMatchmaking(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamMatchmakingServers * SteamAPI_ISteamClient_GetISteamMatchmakingServers(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
void * SteamAPI_ISteamClient_GetISteamGenericInterface(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamUserStats * SteamAPI_ISteamClient_GetISteamUserStats(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamGameServerStats * SteamAPI_ISteamClient_GetISteamGameServerStats(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamApps * SteamAPI_ISteamClient_GetISteamApps(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamNetworking * SteamAPI_ISteamClient_GetISteamNetworking(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamRemoteStorage * SteamAPI_ISteamClient_GetISteamRemoteStorage(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamScreenshots * SteamAPI_ISteamClient_GetISteamScreenshots(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
...
SteamWorks_ISteamHTTP * SteamAPI_ISteamClient_GetISteamHTTP(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamUnifiedMessages * SteamAPI_ISteamClient_GetISteamUnifiedMessages(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamController * SteamAPI_ISteamClient_GetISteamController(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamUGC * SteamAPI_ISteamClient_GetISteamUGC(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamAppList * SteamAPI_ISteamClient_GetISteamAppList(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamUser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamMusic * SteamAPI_ISteamClient_GetISteamMusic(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamMusicRemote * SteamAPI_ISteamClient_GetISteamMusicRemote(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamHTMLSurface * SteamAPI_ISteamClient_GetISteamHTMLSurface(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamInventory * SteamAPI_ISteamClient_GetISteamInventory(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
SteamWorks_ISteamVideo * SteamAPI_ISteamClient_GetISteamVideo(SteamWorks_ISteamClient * self, SteamWorks_HSteamUser hSteamuser, SteamWorks_HSteamPipe hSteamPipe,
  const char * pchVersion);
...
void SteamAPI_ISteamUser_TrackAppUsageEvent(SteamWorks_ISteamUser * self, SteamWorks_CGameID gameID, int eAppUsageEvent,
...
SteamWorks_SteamAPICall_t SteamAPI_ISteamUser_RequestStoreAuthURL(SteamWorks_ISteamUser * self,
...
SteamWorks_SteamAPICall_t SteamAPI_ISteamFriends_SetPersonaName(SteamWorks_ISteamFriends * self,
...
void SteamAPI_ISteamFriends_ActivateGameOverlay(SteamWorks_ISteamFriends * self,
  const char * pchDialog);
void SteamAPI_ISteamFriends_ActivateGameOverlayToUser(SteamWorks_ISteamFriends * self,
  const char * pchDialog, SteamWorks_CSteamID steamID);
void SteamAPI_ISteamFriends_ActivateGameOverlayToWebPage(SteamWorks_ISteamFriends * self,
  const char * pchURL);
...
bool SteamAPI_ISteamFriends_SetRichPresence(SteamWorks_ISteamFriends * self,
  const char * pchKey,
    const char * pchValue);
void SteamAPI_ISteamFriends_ClearRichPresence(SteamWorks_ISteamFriends * self);
const char * SteamAPI_ISteamFriends_GetFriendRichPresence(SteamWorks_ISteamFriends * self, SteamWorks_CSteamID steamIDFriend,
  const char * pchKey);
...
bool SteamAPI_ISteamFriends_InviteUserToGame(SteamWorks_ISteamFriends * self, SteamWorks_CSteamID steamIDFriend,
...
bool SteamAPI_ISteamFriends_SendClanChatMessage(SteamWorks_ISteamFriends * self, SteamWorks_CSteamID steamIDClanChat,
  const char * pchText);
...
bool SteamAPI_ISteamFriends_ReplyToFriendMessage(SteamWorks_ISteamFriends * self, SteamWorks_CSteamID steamIDFriend,
...
SteamWorks_SteamAPICall_t SteamAPI_ISteamUtils_CheckFileSignature(SteamWorks_ISteamUtils * self,
  const char * szFileName);
bool SteamAPI_ISteamUtils_ShowGamepadTextInput(SteamWorks_ISteamUtils * self, SteamWorks_EGamepadTextInputMode eInputMode, SteamWorks_EGamepadTextInputLineMode eLineInputMode,
  const char * pchDescription, SteamWorks_uint32 unCharMax,
...
void SteamAPI_ISteamMatchmaking_AddRequestLobbyListStringFilter(SteamWorks_ISteamMatchmaking * self,
  const char * pchKeyToMatch,
    const char * pchValueToMatch, SteamWorks_ELobbyComparison eComparisonType);
void SteamAPI_ISteamMatchmaking_AddRequestLobbyListNumericalFilter(SteamWorks_ISteamMatchmaking * self,
  const char * pchKeyToMatch, int nValueToMatch, SteamWorks_ELobbyComparison eComparisonType);
void SteamAPI_ISteamMatchmaking_AddRequestLobbyListNearValueFilter(SteamWorks_ISteamMatchmaking * self,
...
const char * SteamAPI_ISteamMatchmaking_GetLobbyData(SteamWorks_ISteamMatchmaking * self, SteamWorks_CSteamID steamIDLobby,
  const char * pchKey);
bool SteamAPI_ISteamMatchmaking_SetLobbyData(SteamWorks_ISteamMatchmaking * self, SteamWorks_CSteamID steamIDLobby,
  const char * pchKey,
    const char * pchValue);
...
bool SteamAPI_ISteamMatchmaking_DeleteLobbyData(SteamWorks_ISteamMatchmaking * self, SteamWorks_CSteamID steamIDLobby,
  const char * pchKey);
const char * SteamAPI_ISteamMatchmaking_GetLobbyMemberData(SteamWorks_ISteamMatchmaking * self, SteamWorks_CSteamID steamIDLobby, SteamWorks_CSteamID steamIDUser,
  const char * pchKey);
void SteamAPI_ISteamMatchmaking_SetLobbyMemberData(SteamWorks_ISteamMatchmaking * self, SteamWorks_CSteamID steamIDLobby,
  const char * pchKey,
    const char * pchValue);
...
void SteamAPI_ISteamMatchmakingPlayersResponse_AddPlayerToList(SteamWorks_ISteamMatchmakingPlayersResponse * self,
...
void SteamAPI_ISteamMatchmakingRulesResponse_RulesResponded(SteamWorks_ISteamMatchmakingRulesResponse * self,
  const char * pchRule,
    const char * pchValue);
...
bool SteamAPI_ISteamRemoteStorage_FileWrite(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile, void * pvData, SteamWorks_int32 cubData);
SteamWorks_int32 SteamAPI_ISteamRemoteStorage_FileRead(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile, void * pvData, SteamWorks_int32 cubDataToRead);
SteamWorks_SteamAPICall_t SteamAPI_ISteamRemoteStorage_FileWriteAsync(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile, void * pvData, SteamWorks_uint32 cubData);
SteamWorks_SteamAPICall_t SteamAPI_ISteamRemoteStorage_FileReadAsync(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile, SteamWorks_uint32 nOffset, SteamWorks_uint32 cubToRead);
...
bool SteamAPI_ISteamRemoteStorage_FileForget(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile);
bool SteamAPI_ISteamRemoteStorage_FileDelete(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile);
SteamWorks_SteamAPICall_t SteamAPI_ISteamRemoteStorage_FileShare(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile);
bool SteamAPI_ISteamRemoteStorage_SetSyncPlatforms(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile, SteamWorks_ERemoteStoragePlatform eRemoteStoragePlatform);
SteamWorks_UGCFileWriteStreamHandle_t SteamAPI_ISteamRemoteStorage_FileWriteStreamOpen(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile);
...
bool SteamAPI_ISteamRemoteStorage_FileExists(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile);
bool SteamAPI_ISteamRemoteStorage_FilePersisted(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile);
SteamWorks_int32 SteamAPI_ISteamRemoteStorage_GetFileSize(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile);
SteamWorks_int64 SteamAPI_ISteamRemoteStorage_GetFileTimestamp(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile);
SteamWorks_ERemoteStoragePlatform SteamAPI_ISteamRemoteStorage_GetSyncPlatforms(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile);
...
SteamWorks_SteamAPICall_t SteamAPI_ISteamRemoteStorage_PublishWorkshopFile(SteamWorks_ISteamRemoteStorage * self,
  const char * pchFile,
    const char * pchPreviewFile, SteamWorks_AppId_t nConsumerAppId,
      const char * pchTitle,
        const char * pchDescription, SteamWorks_ERemoteStoragePublishedFileVisibility eVisibility, SteamWorks_SteamParamStringArray_t * pTags, SteamWorks_EWorkshopFileType eWorkshopFileType);
...
bool SteamAPI_ISteamRemoteStorage_UpdatePublishedFileFile(SteamWorks_ISteamRemoteStorage * self, SteamWorks_PublishedFileUpdateHandle_t updateHandle,
  const char * pchFile);
bool SteamAPI_ISteamRemoteStorage_UpdatePublishedFilePreviewFile(SteamWorks_ISteamRemoteStorage * self, SteamWorks_PublishedFileUpdateHandle_t updateHandle,
  const char * pchPreviewFile);
bool SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTitle(SteamWorks_ISteamRemoteStorage * self, SteamWorks_PublishedFileUpdateHandle_t updateHandle,
  const char * pchTitle);
bool SteamAPI_ISteamRemoteStorage_UpdatePublishedFileDescription(SteamWorks_ISteamRemoteStorage * self, SteamWorks_PublishedFileUpdateHandle_t updateHandle,
...
bool SteamAPI_ISteamRemoteStorage_UpdatePublishedFileSetChangeDescription(SteamWorks_ISteamRemoteStorage * self, SteamWorks_PublishedFileUpdateHandle_t updateHandle,
...
SteamWorks_SteamAPICall_t SteamAPI_ISteamRemoteStorage_PublishVideo(SteamWorks_ISteamRemoteStorage * self, SteamWorks_EWorkshopVideoProvider eVideoProvider,
  const char * pchVideoAccount,
    const char * pchVideoIdentifier,
      const char * pchPreviewFile, SteamWorks_AppId_t nConsumerAppId,
        const char * pchTitle,
          const char * pchDescription, SteamWorks_ERemoteStoragePublishedFileVisibility eVisibility, SteamWorks_SteamParamStringArray_t * pTags);
...
SteamWorks_SteamAPICall_t SteamAPI_ISteamRemoteStorage_UGCDownloadToLocation(SteamWorks_ISteamRemoteStorage * self, SteamWorks_UGCHandle_t hContent,
  const char * pchLocation, SteamWorks_uint32 unPriority);
bool SteamAPI_ISteamUserStats_RequestCurrentStats(SteamWorks_ISteamUserStats * self);
bool SteamAPI_ISteamUserStats_GetStat(SteamWorks_ISteamUserStats * self,
  const char * pchName, SteamWorks_int32 * pData);
bool SteamAPI_ISteamUserStats_GetStat(SteamWorks_ISteamUserStats * self,
  const char * pchName, float * pData);
bool SteamAPI_ISteamUserStats_SetStat(SteamWorks_ISteamUserStats * self,
  const char * pchName, SteamWorks_int32 nData);
bool SteamAPI_ISteamUserStats_SetStat(SteamWorks_ISteamUserStats * self,
  const char * pchName, float fData);
bool SteamAPI_ISteamUserStats_UpdateAvgRateStat(SteamWorks_ISteamUserStats * self,
  const char * pchName, float flCountThisSession, double dSessionLength);
bool SteamAPI_ISteamUserStats_GetAchievement(SteamWorks_ISteamUserStats * self,
  const char * pchName, bool * pbAchieved);
bool SteamAPI_ISteamUserStats_SetAchievement(SteamWorks_ISteamUserStats * self,
  const char * pchName);
bool SteamAPI_ISteamUserStats_ClearAchievement(SteamWorks_ISteamUserStats * self,
  const char * pchName);
bool SteamAPI_ISteamUserStats_GetAchievementAndUnlockTime(SteamWorks_ISteamUserStats * self,
  const char * pchName, bool * pbAchieved, SteamWorks_uint32 * punUnlockTime);
bool SteamAPI_ISteamUserStats_StoreStats(SteamWorks_ISteamUserStats * self);
int SteamAPI_ISteamUserStats_GetAchievementIcon(SteamWorks_ISteamUserStats * self,
  const char * pchName);
const char * SteamAPI_ISteamUserStats_GetAchievementDisplayAttribute(SteamWorks_ISteamUserStats * self,
  const char * pchName,
    const char * pchKey);
bool SteamAPI_ISteamUserStats_IndicateAchievementProgress(SteamWorks_ISteamUserStats * self,
  const char * pchName, SteamWorks_uint32 nCurProgress, SteamWorks_uint32 nMaxProgress);
...
bool SteamAPI_ISteamUserStats_GetUserStat(SteamWorks_ISteamUserStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, SteamWorks_int32 * pData);
bool SteamAPI_ISteamUserStats_GetUserStat(SteamWorks_ISteamUserStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, float * pData);
bool SteamAPI_ISteamUserStats_GetUserAchievement(SteamWorks_ISteamUserStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, bool * pbAchieved);
bool SteamAPI_ISteamUserStats_GetUserAchievementAndUnlockTime(SteamWorks_ISteamUserStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, bool * pbAchieved, SteamWorks_uint32 * punUnlockTime);
bool SteamAPI_ISteamUserStats_ResetAllStats(SteamWorks_ISteamUserStats * self, bool bAchievementsToo);
SteamWorks_SteamAPICall_t SteamAPI_ISteamUserStats_FindOrCreateLeaderboard(SteamWorks_ISteamUserStats * self,
  const char * pchLeaderboardName, SteamWorks_ELeaderboardSortMethod eLeaderboardSortMethod, SteamWorks_ELeaderboardDisplayType eLeaderboardDisplayType);
SteamWorks_SteamAPICall_t SteamAPI_ISteamUserStats_FindLeaderboard(SteamWorks_ISteamUserStats * self,
...
bool SteamAPI_ISteamUserStats_GetAchievementAchievedPercent(SteamWorks_ISteamUserStats * self,
...
bool SteamAPI_ISteamUserStats_GetGlobalStat(SteamWorks_ISteamUserStats * self,
  const char * pchStatName, SteamWorks_int64 * pData);
bool SteamAPI_ISteamUserStats_GetGlobalStat(SteamWorks_ISteamUserStats * self,
  const char * pchStatName, double * pData);
SteamWorks_int32 SteamAPI_ISteamUserStats_GetGlobalStatHistory(SteamWorks_ISteamUserStats * self,
  const char * pchStatName, SteamWorks_int64 * pData, SteamWorks_uint32 cubData);
SteamWorks_int32 SteamAPI_ISteamUserStats_GetGlobalStatHistory(SteamWorks_ISteamUserStats * self,
  const char * pchStatName, double * pData, SteamWorks_uint32 cubData);
...
const char * SteamAPI_ISteamApps_GetLaunchQueryParam(SteamWorks_ISteamApps * self,
  const char * pchKey);
...
SteamWorks_SteamAPICall_t SteamAPI_ISteamApps_GetFileDetails(SteamWorks_ISteamApps * self,
...
SteamWorks_ScreenshotHandle SteamAPI_ISteamScreenshots_AddScreenshotToLibrary(SteamWorks_ISteamScreenshots * self,
...
bool SteamAPI_ISteamScreenshots_SetLocation(SteamWorks_ISteamScreenshots * self, SteamWorks_ScreenshotHandle hScreenshot,
...
SteamWorks_ScreenshotHandle SteamAPI_ISteamScreenshots_AddVRScreenshotToLibrary(SteamWorks_ISteamScreenshots * self, SteamWorks_EVRScreenshotType eType,
  const char * pchFilename,
...
bool SteamAPI_ISteamMusicRemote_RegisterSteamMusicRemote(SteamWorks_ISteamMusicRemote * self,
  const char * pchName);
...
bool SteamAPI_ISteamMusicRemote_SetDisplayName(SteamWorks_ISteamMusicRemote * self,
...
bool SteamAPI_ISteamMusicRemote_UpdateCurrentEntryText(SteamWorks_ISteamMusicRemote * self,
  const char * pchText);
...
bool SteamAPI_ISteamMusicRemote_SetQueueEntry(SteamWorks_ISteamMusicRemote * self, int nID, int nPosition,
...
bool SteamAPI_ISteamMusicRemote_SetPlaylistEntry(SteamWorks_ISteamMusicRemote * self, int nID, int nPosition,
  const char * pchEntryText);
...
SteamWorks_HTTPRequestHandle SteamAPI_ISteamHTTP_CreateHTTPRequest(SteamWorks_ISteamHTTP * self, SteamWorks_EHTTPMethod eHTTPRequestMethod,
...
bool SteamAPI_ISteamHTTP_SetHTTPRequestHeaderValue(SteamWorks_ISteamHTTP * self, SteamWorks_HTTPRequestHandle hRequest,
  const char * pchHeaderName,
    const char * pchHeaderValue);
bool SteamAPI_ISteamHTTP_SetHTTPRequestGetOrPostParameter(SteamWorks_ISteamHTTP * self, SteamWorks_HTTPRequestHandle hRequest,
...
bool SteamAPI_ISteamHTTP_GetHTTPResponseHeaderSize(SteamWorks_ISteamHTTP * self, SteamWorks_HTTPRequestHandle hRequest,
  const char * pchHeaderName, SteamWorks_uint32 * unResponseHeaderSize);
bool SteamAPI_ISteamHTTP_GetHTTPResponseHeaderValue(SteamWorks_ISteamHTTP * self, SteamWorks_HTTPRequestHandle hRequest,
  const char * pchHeaderName, SteamWorks_uint8 * pHeaderValueBuffer, SteamWorks_uint32 unBufferSize);
...
bool SteamAPI_ISteamHTTP_SetHTTPRequestRawPostBody(SteamWorks_ISteamHTTP * self, SteamWorks_HTTPRequestHandle hRequest,
  const char * pchContentType, SteamWorks_uint8 * pubBody, SteamWorks_uint32 unBodyLen);
...
bool SteamAPI_ISteamHTTP_SetCookie(SteamWorks_ISteamHTTP * self, SteamWorks_HTTPCookieContainerHandle hCookieContainer,
  const char * pchHost,
    const char * pchUrl,
...
bool SteamAPI_ISteamHTTP_SetHTTPRequestUserAgentInfo(SteamWorks_ISteamHTTP * self, SteamWorks_HTTPRequestHandle hRequest,
...
SteamWorks_ClientUnifiedMessageHandle SteamAPI_ISteamUnifiedMessages_SendMethod(SteamWorks_ISteamUnifiedMessages * self,
  const char * pchServiceMethod, void * pRequestBuffer, SteamWorks_uint32 unRequestBufferSize, SteamWorks_uint64 unContext);
...
bool SteamAPI_ISteamUnifiedMessages_SendNotification(SteamWorks_ISteamUnifiedMessages * self,
  const char * pchServiceNotification, void * pNotificationBuffer, SteamWorks_uint32 unNotificationBufferSize);
...
SteamWorks_ControllerActionSetHandle_t SteamAPI_ISteamController_GetActionSetHandle(SteamWorks_ISteamController * self,
...
SteamWorks_ControllerDigitalActionHandle_t SteamAPI_ISteamController_GetDigitalActionHandle(SteamWorks_ISteamController * self,
...
SteamWorks_ControllerAnalogActionHandle_t SteamAPI_ISteamController_GetAnalogActionHandle(SteamWorks_ISteamController * self,
  const char * pszActionName);
...
bool SteamAPI_ISteamUGC_AddRequiredTag(SteamWorks_ISteamUGC * self, SteamWorks_UGCQueryHandle_t handle,
  const char * pTagName);
bool SteamAPI_ISteamUGC_AddExcludedTag(SteamWorks_ISteamUGC * self, SteamWorks_UGCQueryHandle_t handle,
  const char * pTagName);
...
bool SteamAPI_ISteamUGC_SetLanguage(SteamWorks_ISteamUGC * self, SteamWorks_UGCQueryHandle_t handle,
...
bool SteamAPI_ISteamUGC_SetCloudFileNameFilter(SteamWorks_ISteamUGC * self, SteamWorks_UGCQueryHandle_t handle,
...
bool SteamAPI_ISteamUGC_SetSearchText(SteamWorks_ISteamUGC * self, SteamWorks_UGCQueryHandle_t handle,
...
bool SteamAPI_ISteamUGC_AddRequiredKeyValueTag(SteamWorks_ISteamUGC * self, SteamWorks_UGCQueryHandle_t handle,
  const char * pKey,
    const char * pValue);
...
bool SteamAPI_ISteamUGC_SetItemTitle(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
  const char * pchTitle);
bool SteamAPI_ISteamUGC_SetItemDescription(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
  const char * pchDescription);
bool SteamAPI_ISteamUGC_SetItemUpdateLanguage(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
  const char * pchLanguage);
bool SteamAPI_ISteamUGC_SetItemMetadata(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
...
bool SteamAPI_ISteamUGC_SetItemContent(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
  const char * pszContentFolder);
bool SteamAPI_ISteamUGC_SetItemPreview(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
  const char * pszPreviewFile);
bool SteamAPI_ISteamUGC_RemoveItemKeyValueTags(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
  const char * pchKey);
bool SteamAPI_ISteamUGC_AddItemKeyValueTag(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
  const char * pchKey,
    const char * pchValue);
bool SteamAPI_ISteamUGC_AddItemPreviewFile(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
  const char * pszPreviewFile, SteamWorks_EItemPreviewType type);
bool SteamAPI_ISteamUGC_AddItemPreviewVideo(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
  const char * pszVideoID);
bool SteamAPI_ISteamUGC_UpdateItemPreviewFile(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle, SteamWorks_uint32 index,
  const char * pszPreviewFile);
bool SteamAPI_ISteamUGC_UpdateItemPreviewVideo(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle, SteamWorks_uint32 index,
  const char * pszVideoID);
...
SteamWorks_SteamAPICall_t SteamAPI_ISteamUGC_SubmitItemUpdate(SteamWorks_ISteamUGC * self, SteamWorks_UGCUpdateHandle_t handle,
...
bool SteamAPI_ISteamUGC_BInitWorkshopForGameServer(SteamWorks_ISteamUGC * self, SteamWorks_DepotId_t unWorkshopDepotID,
...
SteamWorks_SteamAPICall_t SteamAPI_ISteamHTMLSurface_CreateBrowser(SteamWorks_ISteamHTMLSurface * self,
...
void SteamAPI_ISteamHTMLSurface_LoadURL(SteamWorks_ISteamHTMLSurface * self, SteamWorks_HHTMLBrowser unBrowserHandle,
  const char * pchURL,
    const char * pchPostData);
...
void SteamAPI_ISteamHTMLSurface_AddHeader(SteamWorks_ISteamHTMLSurface * self, SteamWorks_HHTMLBrowser unBrowserHandle,
  const char * pchKey,
    const char * pchValue);
void SteamAPI_ISteamHTMLSurface_ExecuteJavascript(SteamWorks_ISteamHTMLSurface * self, SteamWorks_HHTMLBrowser unBrowserHandle,
...
void SteamAPI_ISteamHTMLSurface_Find(SteamWorks_ISteamHTMLSurface * self, SteamWorks_HHTMLBrowser unBrowserHandle,
  const char * pchSearchStr, bool bCurrentlyInFind, bool bReverse);
...
void SteamAPI_ISteamHTMLSurface_SetCookie(SteamWorks_ISteamHTMLSurface * self,
  const char * pchHostname,
    const char * pchKey,
      const char * pchValue,
        const char * pchPath, SteamWorks_RTime32 nExpires, bool bSecure, bool bHTTPOnly);
...
bool SteamAPI_ISteamInventory_GetResultItemProperty(SteamWorks_ISteamInventory * self, SteamWorks_SteamInventoryResult_t resultHandle, SteamWorks_uint32 unItemIndex,
  const char * pchPropertyName, char * pchValueBuffer, SteamWorks_uint32 * punValueBufferSizeOut);
...
bool SteamAPI_ISteamInventory_GetItemDefinitionProperty(SteamWorks_ISteamInventory * self, SteamWorks_SteamItemDef_t iDefinition,
  const char * pchPropertyName, char * pchValueBuffer, SteamWorks_uint32 * punValueBufferSizeOut);
...
bool SteamAPI_ISteamGameServer_InitGameServer(SteamWorks_ISteamGameServer * self, SteamWorks_uint32 unIP, SteamWorks_uint16 usGamePort, SteamWorks_uint16 usQueryPort, SteamWorks_uint32 unFlags, SteamWorks_AppId_t nGameAppId,
  const char * pchVersionString);
void SteamAPI_ISteamGameServer_SetProduct(SteamWorks_ISteamGameServer * self,
  const char * pszProduct);
void SteamAPI_ISteamGameServer_SetGameDescription(SteamWorks_ISteamGameServer * self,
  const char * pszGameDescription);
void SteamAPI_ISteamGameServer_SetModDir(SteamWorks_ISteamGameServer * self,
  const char * pszModDir);
void SteamAPI_ISteamGameServer_SetDedicatedServer(SteamWorks_ISteamGameServer * self, bool bDedicated);
void SteamAPI_ISteamGameServer_LogOn(SteamWorks_ISteamGameServer * self,
  const char * pszToken);
...
void SteamAPI_ISteamGameServer_SetServerName(SteamWorks_ISteamGameServer * self,
  const char * pszServerName);
void SteamAPI_ISteamGameServer_SetMapName(SteamWorks_ISteamGameServer * self,
...
void SteamAPI_ISteamGameServer_SetSpectatorServerName(SteamWorks_ISteamGameServer * self,
  const char * pszSpectatorServerName);
void SteamAPI_ISteamGameServer_ClearAllKeyValues(SteamWorks_ISteamGameServer * self);
void SteamAPI_ISteamGameServer_SetKeyValue(SteamWorks_ISteamGameServer * self,
  const char * pKey,
    const char * pValue);
void SteamAPI_ISteamGameServer_SetGameTags(SteamWorks_ISteamGameServer * self,
  const char * pchGameTags);
void SteamAPI_ISteamGameServer_SetGameData(SteamWorks_ISteamGameServer * self,
  const char * pchGameData);
void SteamAPI_ISteamGameServer_SetRegion(SteamWorks_ISteamGameServer * self,
...
bool SteamAPI_ISteamGameServer_BUpdateUserData(SteamWorks_ISteamGameServer * self, SteamWorks_CSteamID steamIDUser,
  const char * pchPlayerName, SteamWorks_uint32 uScore);
...
bool SteamAPI_ISteamGameServerStats_GetUserStat(SteamWorks_ISteamGameServerStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, SteamWorks_int32 * pData);
bool SteamAPI_ISteamGameServerStats_GetUserStat(SteamWorks_ISteamGameServerStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, float * pData);
bool SteamAPI_ISteamGameServerStats_GetUserAchievement(SteamWorks_ISteamGameServerStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, bool * pbAchieved);
bool SteamAPI_ISteamGameServerStats_SetUserStat(SteamWorks_ISteamGameServerStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, SteamWorks_int32 nData);
bool SteamAPI_ISteamGameServerStats_SetUserStat(SteamWorks_ISteamGameServerStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, float fData);
bool SteamAPI_ISteamGameServerStats_UpdateUserAvgRateStat(SteamWorks_ISteamGameServerStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName, float flCountThisSession, double dSessionLength);
bool SteamAPI_ISteamGameServerStats_SetUserAchievement(SteamWorks_ISteamGameServerStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName);
bool SteamAPI_ISteamGameServerStats_ClearUserAchievement(SteamWorks_ISteamGameServerStats * self, SteamWorks_CSteamID steamIDUser,
  const char * pchName);
...
if not lib.SteamAPI_Init() then
	error("DefSteam: Failed to initialize steamworks")
end
...
if steamworks.unifiedmessages_ptr == nil then
	 print('DefSteam: Failed to load unifiedmessages STEAMUNIFIEDMESSAGES_INTERFACE_VERSION001')
else
...
if steamworks.friends_ptr == nil then
	 print('DefSteam: Failed to load friends SteamFriends015')
else
...
if steamworks.networking_ptr == nil then
	 print('DefSteam: Failed to load networking SteamNetworking005')
else
...
if steamworks.controller_ptr == nil then
	 print('DefSteam: Failed to load controller SteamController005')
else
...
if steamworks.matchmakingservers_ptr == nil then
	 print('DefSteam: failed to load matchmakingservers SteamMatchMakingServers002')
else
...
if steamworks.userstats_ptr == nil then
	 print('DefSteam: Failed to load userstats STEAMUSERSTATS_INTERFACE_VERSION011')
else
...
if steamworks.htmlsurface_ptr == nil then
	 print('DefSteam: failed to load htmlsurface STEAMHTMLSURFACE_INTERFACE_VERSION_004')
else
...
if steamworks.screenshots_ptr == nil then
	 print('DefSteam: Failed to load screenshots STEAMSCREENSHOTS_INTERFACE_VERSION003')
else
...
if steamworks.ugc_ptr == nil then
	 print('DefSteam: Failed to load ugc STEAMUGC_INTERFACE_VERSION010')
else
...
if steamworks.apps_ptr == nil then
	 print('DefSteam: Failed to load apps STEAMAPPS_INTERFACE_VERSION008')
else
...
if steamworks.inventory_ptr == nil then
	 print('DefSteam: Failed to load inventory STEAMINVENTORY_INTERFACE_V002')
else
...
if steamworks.video_ptr == nil then
	 print('DefSteam: Failed to load video STEAMVIDEO_INTERFACE_V002')
else
...
if steamworks.musicremote_ptr == nil then
	 print('DefSteam: Failed to load musicremote STEAMMUSICREMOTE_INTERFACE_VERSION001')
else
...
if steamworks.music_ptr == nil then
	 print('DefSteam: Failed to load music STEAMMUSIC_INTERFACE_VERSION001')
else
...
if steamworks.http_ptr == nil then
	 print('DefSteam: failed to load http STEAMHTTP_INTERFACE_VERSION002')
else
...
if steamworks.utils_ptr == nil then
	 print('DefSteam: Failed to load utils SteamUtils009')
else
...
if steamworks.remotestorage_ptr == nil then
	 print('DefSteam: Failed to load remotestorage STEAMREMOTESTORAGE_INTERFACE_VERSION014')
else
...
if steamworks.applist_ptr == nil then
	 print('DefSteam: Failed to load applist STEAMAPPLIST_INTERFACE_VERSION001')
else
...
if steamworks.matchmaking_ptr == nil then
	 print('DefSteam: Failed to load matchmaking SteamMatchMaking009')
else
...
if steamworks.user_ptr == nil then
	 print('DefSteam: Failed to load user SteamUser019')
else
...
function steamworks.SteamAPI_Shutdown() return lib.SteamAPI_Shutdown() end
return steamworks